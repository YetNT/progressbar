 ...
 */
function progressBar(percentage, barWidth, emptyChars, fullChars, returnAr, firstEdgeOverride, lastEdgeOverride) {
    ...
    if ((percentage > 100 ||
        ...
        throw Error(`percentage should be a valid integer/float between 0 and 100.` +
            "\n" +
            out);
    }
    ...
    if (typeof fullChars !== "string" || typeof emptyChars !== "string") {
        throw Error(`emptyChar (param 3) and fullChar (param 4) should be of type String`);
    }
    ...
    for (let i = 0; i < barWidth; i++) {
        ...
        if (i < units) {
            ...
            if (typeof firstEdgeOverride !== "undefined" &&
