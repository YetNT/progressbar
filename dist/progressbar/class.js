...
class ProgressBar {
     ...
     *
     */
    constructor(percentage, barWidth, emptyChars, fullChars, firstEdgeOverride, lastEdgeOverride) {
        ...
        if ((percentage > 100 ||
            ...
            throw new TypeError(`percentage should be a valid integer/float between 0 and 100.` +
                "\n" +
                out);
        }
        ...
        if (typeof fullChars !== "string" || typeof emptyChars !== "string") {
            throw new TypeError(`emptyChar (param 3) and fullChar (param 4) should be of type String`);
        }
        if (firstEdgeOverride !== undefined &&
    ...
    updateBar() {
        ...
        for (let i = 0; i < this._barWidth; i++) {
            ...
            if (i < units) {
                ...
                if (typeof this.firstEdgeOverride !== "undefined" &&
